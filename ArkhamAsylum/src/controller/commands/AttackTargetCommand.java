 ...
 */
public class AttackTargetCommand implements ArkhamAsylumGameCommand {
   ...
   */
  public AttackTargetCommand(Scanner inputScanner, Appendable outputAppendable) {
  ...
  public void execute(ArkhamAsylumWorld model) {
    ...
    while (!isValidArguments) {
      ...
      try {
        outputAppendable.append("Please enter the item name to use for attack: \n");
